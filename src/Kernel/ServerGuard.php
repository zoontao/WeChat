...
class ServerGuard
{
     ...
     * Get request message.
     *
     * @return array|\WeChat\Kernel\Support\Collection|object|string
     *
     * @throws BadRequestException
     * @throws \WeChat\Kernel\Exceptions\InvalidArgumentException
     * @throws \WeChat\Kernel\Exceptions\InvalidConfigException
     ...
     * @param string                                                   $to
     * @param string                                                   $from
     * @param \WeChat\Kernel\Contracts\MessageInterface|string|int $message
     *
     * @return string
     *
     * @throws \WeChat\Kernel\Exceptions\InvalidArgumentException
