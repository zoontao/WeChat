...
namespace WeChat\MicroMerchant\Kernel;

use WeChat\Kernel\Exceptions\InvalidArgumentException;
use WeChat\Kernel\Support;
use WeChat\MicroMerchant\Application;
use WeChat\MicroMerchant\Kernel\Exceptions\EncryptException;
use WeChat\Payment\Kernel\BaseClient as PaymentBaseClient;
...
class BaseClient extends PaymentBaseClient
{
     ...
     *
     * @param \WeChat\MicroMerchant\Application $app
     */
